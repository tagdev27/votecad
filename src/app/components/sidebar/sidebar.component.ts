...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/backend-users', title: 'Backend-Users', icon: 'ni-planet text-blue', class: '', access: false },
  { path: '/roles', title: 'Roles', icon: 'ni-planet text-blue', class: '', access: false },
  { path: '/category', title: 'Category', icon: 'ni-planet text-blue', class: '', access: false },
  { path: '/sliders', title: 'Slider Settings', icon: 'ni-planet text-blue', class: '', access: false },
  { path: '/shows', title: 'Shows / Events', icon: 'ni-planet text-blue', class: '', access: false },
  { path: '/contestants', title: 'Contestants', icon: 'ni-planet text-blue', class: '', access: false },
